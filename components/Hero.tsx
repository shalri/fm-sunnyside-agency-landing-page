...
export default function Hero() {
  return (
    ...
    <section className="hero-bg group flex h-[480px] w-full flex-col items-center justify-center gap-y-14 bg-[#3dbeff] sm:h-[600px] sm:justify-start sm:gap-y-24 lg:h-[720px]">
      ...
      <div className="relative h-[116px] w-[40px] group-hover:animate-pulse">
        <Image
